...
\moveleft.5\hoffset\centerline{\
  ...
  %gitlab
  {\faGithubAlt} \href{http://$git.url$$if(git.user)$/$git.user$$endif$}{$git.url$$if(git.user)$/$git.user$$endif$} \hspace{2 mm}
  %linkedin
  \href{http://$linkedin.url$$if(linkedin.user)$/$linkedin.user$$endif$}{$linkedin.url$$if(linkedin.user)$/$linkedin.user$$endif$}
}
