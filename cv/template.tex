...
\moveleft.5\hoffset\centerline{\
  ...
  %email
  \faIcon[regular]{envelope} \href{mailto:}{$email$} \hspace{2 mm}
  %website
  % {\faGlobe} \href{http://$url$}{$url$}\hspace{3 mm}
  %gitlab
  \faIcon[brands]{github-alt} \href{http://$git.url$$if(git.user)$/$git.user$$endif$}{$git.url$$if(git.user)$/$git.user$$endif$} \hspace{2 mm}
  %linkedin
  \faIcon[brands]{linkedin} \href{http://$linkedin.url$$if(linkedin.user)$/$linkedin.user$$endif$}{$linkedin.url$$if(linkedin.user)$/$linkedin.user$$endif$}
}
